...
export default function ProfileFrame({ frame, src, size = 'md' }: ProfileFrameProps) {
  ...
  switch (frame) {
    ...
    case 'frame-elite':
      ...
      break;
    default:
      bgClass = 'bg-zinc-900 border border-white/10';
      borderClass = 'p-0';
      break;
  }
  ...
  return (
    <div className={`relative flex items-center justify-center flex-shrink-0 ${sizeClass}`}>
      ...
      >
        <div 
          className={`w-full h-full bg-zinc-900 flex items-center justify-center ${shapeClass} relative z-10 overflow-hidden`}
        >
          {src ? (
