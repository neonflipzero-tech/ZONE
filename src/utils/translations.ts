export const t = (key: string, lang: 'en' | 'id', params?: Record<string, string | number>): string => {
  const translations: Record<string, Record<'en' | 'id', string>> = {
    ...
    'profile.neural_advisor': { en: 'Neural Advisor', id: 'Penasihat Neural' },
    'profile.guide_info': { en: 'Guide & Information', id: 'Panduan & Informasi' },
    'profile.weekly_chart': { en: 'Weekly Bar Chart', id: 'Grafik Batang Mingguan' },
    'profile.weekly_chart_desc': { en: 'This chart shows your mission completion count for the last 7 days.', id: 'Grafik ini menunjukkan jumlah misi yang kamu selesaikan selama 7 hari terakhir.' },
    'profile.weekly_chart_goal_desc': { en: 'The height of each bar represents how many missions you completed. Aim for higher bars to maintain your momentum!', id: 'Tinggi setiap batang mewakili jumlah misi yang kamu selesaikan. Targetkan batang yang lebih tinggi untuk menjaga momentummu!' },
    'profile.consistency_quote': { en: 'Consistency is the key to mastery.', id: 'Konsistensi adalah kunci penguasaan.' },
    ...
    'inventory.title': { en: 'Inventory', id: 'Inventori' },
    'inventory.items': { en: 'Items', id: 'Item' },
    'inventory.item_used': { en: 'ITEM USED!', id: 'ITEM DIGUNAKAN!' },
    'inventory.active': { en: 'Active ({time})', id: 'Aktif ({time})' },
    'inventory.auto_use_streak': { en: 'Automatically used when missed', id: 'Otomatis digunakan saat terlewat' },
    ...
    'profile.frame.diamond': { en: 'Reach Diamond Rank', id: 'Capai Rank Berlian' },
    ...
    'frames.desc.diamond': { en: 'Reach Diamond Rank', id: 'Capai Rank Berlian' },
    ...
    'leaderboard.badges_earned': { en: '{count} Badges Earned', id: '{count} Lencana Didapat' },
    'leaderboard.no_badges': { en: 'No badges earned yet', id: 'Belum ada lencana yang didapat' },
    'leaderboard.syncing_details': { en: 'Syncing details...', id: 'Sinkronisasi detail...' },
    'profile.stat.integrity': { en: 'Integrity', id: 'Integritas' },
    'profile.ovr': { en: 'OVR', id: 'OVR' },
    'profile.rank': { en: 'Rank', id: 'Pangkat' },
    'profile.streak': { en: 'Streak', id: 'Streak' },
    'profile.view_rival': { en: 'VIEW RIVAL PROFILE', id: 'LIHAT PROFIL RIVAL' },
    'app.rival_crushed': { en: 'RIVAL CRUSHED!', id: 'RIVAL DIHANCURKAN!' },
    'app.experience': { en: 'Experience', id: 'Pengalaman' },
    'app.new_title': { en: 'New Title', id: 'Gelar Baru' },
    'item.xp_potion.name': { en: '2x XP Potion', id: 'Ramuan 2x XP' },
    'item.xp_potion.desc': { en: 'Double XP for 24 hours', id: 'Gandakan XP selama 24 jam' },
    'item.streak_freeze.name': { en: 'Streak Freeze', id: 'Streak Freeze' },
    'item.streak_freeze.desc': { en: 'Protect your streak for 1 day', id: 'Lindungi streak Anda selama 1 hari' },
    'item.coin_potion.name': { en: '2x Coin Potion', id: 'Ramuan 2x Koin' },
    'item.coin_potion.desc': { en: 'Double Zone Coins for 24 hours', id: 'Gandakan Koin Zona selama 24 jam' },
  };
